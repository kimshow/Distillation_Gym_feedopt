...
#COCOフローシートの蒸留塔を操作するためのクラス
class Column:
    def __init__(self, in_number, tops_number, bottoms_number, n_stages, feed_stage, reflux_ratio, reboil_ratio, OperatingPressure, InletTemperature, TAC):
...
class State:
    ...
    """
    #蒸留塔の設定を決める
    def add_column_data(self, in_number, tops_number, bottoms_number, n_stages, feed_stage, reflux_ratio, reboil_ratio,
                        OperatingPressure, InletTemperature, TAC):
        self.column_data.append(Column(in_number, tops_number, bottoms_number, n_stages, feed_stage, reflux_ratio, reboil_ratio,
                                       OperatingPressure, InletTemperature, TAC))
